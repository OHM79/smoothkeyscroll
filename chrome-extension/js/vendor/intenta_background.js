...
var IntentaPageMonitor = function(){
  return {
    ...
    activateTabUpdatedListener : function(){
      ...
      //var self = this;
      //////Listen for pixel request from content script
      //chrome.runtime.onMessage.addListener(
      //  function(request, sender, sendResponse) {
      //    IntentaDebug("Background Got Message");
      //    IntentaDebug(request.intenta.url);
      ...
      //    if (sender.hasOwnProperty('tab') && sender.tab.active && request.hasOwnProperty('intenta') && (request.intenta.action == 'auction')){
      //      IntentaDebug("Tab is Active");
      //      IntentaDebug(request);
      //      self.request(request, sendResponse);
      //      return true;//Return true to keep channel open.
      //    }
      //  });
    },
